...
<form name='add_content' method='POST' action='" . WWW_BASE_PATH . "manage/news/update/$n_id'>
...
<div class='width_full'>
    <textarea name='article' id='editor' class='editor1' rows='10' style='width:100%'>$article</textarea>
</div>
